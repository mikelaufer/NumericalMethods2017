...
def compute_interior_faces(A, b):
    ...
    for elem_index in range(nelements):
        ...
        time_A = rhoc_elements[elem_index]*msh.volumes[elem_index]/dt
        time_b = (rhoc_elements[elem_index]*msh.volumes[elem_index]/dt)*phi_old[elem_index]
...
if __name__ == '__main__':
    ...
    while t < final_time:
        ...
        while not converged:
            ...
            print('Time: %f, Iteration %d, Error = %g'%(t, iteration, norm))
