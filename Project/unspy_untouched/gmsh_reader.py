...
class GmshReader(object):
    def __init__(self, mshfile):
        ...
        print
        print('{:<30}'.format('Setting Dirichlet & Neumann faces...'))

        # Dirichlet and Neumann faces
        dirichlet_faces = []; dirichlet_faces_val = []
        neumann_faces   = []; neumann_faces_val   = []
        robin_faces     = []; robin_faces_val     = []
                ...
                if tag.startswith('Neumann'):
                    for i in range(self.nfaces):
                        if self.face_markers[i] == tagval:
                            ...
                            neumann_faces_val.append(physval)
        ...
        self.neumann_faces_val = np.asarray(neumann_faces_val)
